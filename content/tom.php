...
<!-- Верхние разделы закончились -->
 ...
 $sql = 'SELECT * FROM `posts` WHERE `id_topic` = 9  ORDER BY id DESC';
...
<?php foreach ($post as $key => $value) :?>
  <div class="row ">
   <div class="bkImg col-md-6 ">
      ...
      <div class="col-md-6 ">
      <a href="secondBooks.php?id=<?=$value['id'];?> ">   <h2  class="featurette-heading"><?=$value['title'];?> <span class="text-muted"></span></h2></a>
        <p class="lead"></p>
      </div>
</div>
<hr class="featurette-divider">
